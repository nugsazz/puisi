...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"ılı ѕℓσωєя вσт  ılı")
                ki.sendText(msg.to,"lıl ѕℓσωєя вσт  lıl")
                kk.sendText(msg.to,"ılı ѕℓσωєя вσт  ılı")
                kc.sendText(msg.to,"lıl ѕℓσωєя вσт  lıl")
                kd.sendText(msg.to,"ılı ѕℓσωєя вσт  ılı")
                ke.sendText(msg.to,"lıl ѕℓσωєя вσт  lıl")
                kf.sendText(msg.to,"ılı ѕℓσωєя вσт  ılı")
#-----------------------------------------------
